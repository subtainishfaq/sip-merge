...
public class MenuBar extends JMenuBar
{
	...
	public void addBlockedListAction(Action action) {
		// TODO Auto-generated method stub
		JMenuItem mItem = new JMenuItem(action);
		//mItem.setMnemonic('B');
		optionsMenu.add(mItem);
	...
	public void addFavoritesAction(Action action) {
		// TODO Auto-generated method stub
		JMenuItem mItem = new JMenuItem(action);
		//mItem.setMnemonic('B');
		optionsMenu.add(mItem);	
	...
	public void addFavoriteListAction(Action action) {
		// TODO Auto-generated method stub
		JMenuItem mItem = new JMenuItem(action);
		//mItem.setMnemonic('B');
		optionsMenu.add(mItem);
	...
	public void addPolicyListAction(Action action) {
		// TODO Auto-generated method stub
		JMenuItem mItem = new JMenuItem(action);
		mItem.setMnemonic('P');
		optionsMenu.add(mItem);
